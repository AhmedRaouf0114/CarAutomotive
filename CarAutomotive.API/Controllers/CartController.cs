...
namespace CarAutomotive.API.Controllers
{
    public class CartController : BaseApiController
    {
        ...
        [HttpPost("{cartId}")]
        public async Task<ActionResult<CartDto>> AddToCart(string cartId, AddToCartDto dto)
        {
        ...
        // PUT: /api/cart/{cartId}
        [HttpPut("{cartId}")]
        public async Task<ActionResult<CartDto>> UpdateQuantity(string cartId, UpdateCartItemDto dto)
        {
        ...
        public async Task<ActionResult<CartDto>> RemoveFromCart(string cartId, int productId)
        {
